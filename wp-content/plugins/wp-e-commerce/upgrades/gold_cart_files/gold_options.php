  ...
  <form method='post' id='gold_cart_form' action=''>
     <div class='postbox'>
     	<h3 class='hndle'><?php echo TXT_WPSC_ACTIVATE_SETTINGS;?></h3>
		  ...
		  ?>
		  		<p><img align='middle' src='/wp-content/plugins/wp-e-commerce/images/tick.png' alt='' title='' />
		  		&nbsp;The gold cart is currently activated.</p>
		  <?php
		    } else{ 
		  ?>
		    	<p><img align='middle' src='/wp-content/plugins/wp-e-commerce/images/cross.png' alt='' title=''/>
