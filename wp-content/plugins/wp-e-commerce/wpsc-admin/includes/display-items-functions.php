...
function wpsc_product_basic_details_form(&$product_data) {
 ...
 <?php
  if($product_data['id'] > 0) {
		...
		//echo " <span>(<a href='".add_query_arg('page','wpsc-edit-products', remove_query_arg('product_id', 'admin.php'))."'>".__('Add Product', 'wpsc')."</a>)</span>";
	} else {
    ...
    <table class='product_editform' >
					...
					<?php if ( $product_data['id'] > 0 ) { ?>
						<div class='admin_product_shorttags'>						
							...
							-->
								...
								<p>
									<a href="<?php echo wpsc_product_url( $product_data['id'] ); ?>" target="_blank" class="button">Просмотр</a>
									<a class="button" target="_blank" href="https://wiki.itural.ru/%D0%A8%D0%BE%D1%80%D1%82%D0%BA%D0%BE%D0%B4%D1%8B,_%D0%BA%D0%BE%D1%82%D0%BE%D1%80%D1%8B%D0%B5_%D0%BD%D1%83%D0%B6%D0%BD%D0%BE_%D0%B8%D1%81%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D1%8C_%D0%BD%D0%B0_%D1%81%D1%82%D1%80%D0%B0%D0%BD%D0%B8%D1%86%D0%B0%D1%85_itural.ru">Шорткоды на Wiki</a>
								</p>
			...
			<tr>
				<td colspan='2' class='itemfirstcol'>  
					<div style='width:470px'>
						<label>Код:</label>
						<div style="font-size: 1.3em;"><?php echo $product_data['id'] == '0'?'':$product_data['id']; ?></div>
					</div>
					<div style='clear:both; height: 0px; margin-bottom: 15px;'></div>
				</td>
			</tr>	
...
*/
			...
			<tr>
				<td colspan='2'>
				 ...
				 <?php
						wpsc_the_editor($product_data['description'], 'content', '', false);
				 ?>
				 </div>
				</td>
			</tr>
	...
	<div class='meta-box-sortables' style='width:470px'>
		<?php
	...
	<div id='wpsc_product_image_forms' class='postbox <?php echo ((array_search('wpsc_product_image_forms', $product_data['closed_postboxes']) !== false) ? 'closed' : ''); ?>' <?php echo ((array_search('wpsc_product_image_forms', $product_data['hidden_postboxes']) !== false) ? 'style="display: none;"' : ''); ?> >
		...
		?>
			...
			jQuery("span#spanButtonPlaceholder").livequery(function() {
				...
				swfu = new SWFUpload({
					button_text: '||| Нажмите здесь, чтобы выбрать файл(ы) |||',
					button_text_style: '',
					button_height: 30,
					button_width: 300,
					/*button_image_url: '/wp-content/plugins/wp-e-commerce/images/swf-upload.jpg',*/
