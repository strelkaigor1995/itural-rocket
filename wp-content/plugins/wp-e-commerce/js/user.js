...
function show_details_box(id,image_id) {
  ...
  if(state != 'block') {
    ...
    document.getElementById(image_id).src = "/wp-content/plugins/wp-e-commerce/images/icon_window_collapse.gif";
	} else {
		document.getElementById(id).style.display = 'none';
		document.getElementById(image_id).src = "/wp-content/plugins/wp-e-commerce/images/icon_window_expand.gif";
	}
  return false;
}
