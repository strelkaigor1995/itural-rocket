...
function arras_addmenu() {
	...
	//exit(var_dump($theme_data->get('Name')));
	
	$options_page = add_menu_page( $theme_data->get('Name'), $theme_data->get('Name'), 8, 'arras-options', 'arras_admin', get_template_directory_uri() . '/images/icon.png');
...
function arras_admin() {
	...
	echo '<div class="wrap"><div class="clearfix"><h2 id="arras-header">Тема редактируется только через файлы!</h2></div>';
